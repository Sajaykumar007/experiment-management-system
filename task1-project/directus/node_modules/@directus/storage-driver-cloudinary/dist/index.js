...
var DriverCloudinary = class {
	...
	*/
	...
	async stat(filepath) {
		...
		const response = await fetch(`https://api.cloudinary.com/v1_1/${this.cloudName}/${resourceType}/explicit`, {
			method: "POST",
			headers: { "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8" },
			body
		});
		if (response.status >= 400) throw new Error(`No stat returned for file "${filepath}"`);
