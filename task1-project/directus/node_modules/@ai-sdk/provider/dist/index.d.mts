...
type EmbeddingModelCallOptions<VALUE> = {
    /**
...
declare class NoSuchModelError extends AISDKError {
    ...
    readonly modelId: string;
    readonly modelType: 'languageModel' | 'textEmbeddingModel' | 'imageModel' | 'transcriptionModel' | 'speechModel' | 'rerankingModel';
